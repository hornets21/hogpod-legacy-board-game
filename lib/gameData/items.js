...
export const BINGO_ITEM = {
  id: "bingo_sign",
  name: "ป้าย Bingo",
  nameEn: "Bingo Sign",
  price: 500,
  description: "ป้ายบิงโกประจำบ้าน แสดงตารางตัวเลขเมื่อตกช่องตรงกับบิงโก รับโบนัส 10,000 Gold ต่อสายที่พิชิตได้!",
  icon: "🎯",
  image: "/images/items/special/bingo.webp",
};
