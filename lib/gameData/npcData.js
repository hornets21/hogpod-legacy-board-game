...
export const NPC_CONFIG = {
  SPAWN_COOLDOWN_SECONDS: 90, // 90 seconds (1.5 minutes)
  PET_CHANGE_FEE: 1000,
...
export const NPCS = {
  ...
  merchant: {
    ...
    description: "ร้านค้าสัญจร เปิดหน้าร้านค้าฮอกปดเมื่อเดินตกช่อง (เกิดใหม่ทันที ดักหน้าผู้เล่น)",
    cooldownSeconds: 0, // พ่อค้าเกิดใหม่ทันที ดักหน้าผู้เล่นเสมอ
  },
};
